                          ...
                          <div class="card-body row">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="distrito" placeholder="Ingrese distrito" name="distrito" value="{{old('distrito')}}">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                                  <label for="localidad">Localidad</label>
                                  <input type="text" class="form-control" id="localidad" placeholder="Ingrese Distrito Localidad" name="localidad" value="{{old('localidad')}}">
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                          ...
                          <div class="card-body row">                                             
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="determinadopor" placeholder="Ingrese" name="determinadopor" value="{{old('determinadopor')}}">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="nIngreso" placeholder="Ingrese nIngreso" name="nIngreso" value="{{old('nIngreso')}}">
                              </div>
                            </div>
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="nColecta" placeholder="Ingrese tipo de preservacion" name="nColecta" value="{{old('nColecta')}}">
                              </div>
                            </div>
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="estadoActual" placeholder="Ingrese Especimen preparado por" name="estadoActual" value="{{old('estadoActual')}}">
                              </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="tPreparacion">Tipo de preparacion</label>
                                    <input type="text" class="form-control" id="tPreparacion" placeholder="Ingrese Responsable de la Base" name="tPreparacion" value="{{old('tPreparacion')}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                  <label for="caracteristicas">Caracteristicas</label>
                                  <textarea class="form-control" id="caracteristicas" placeholder="Ingrese caracteristicas" name="caracteristicas">{{old('caracteristicas')}}</textarea>
                              </div>
                            </div>
                            <div class="col-md-2">
                              <div class="form-group">
