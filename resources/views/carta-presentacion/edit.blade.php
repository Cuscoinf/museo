        ...
        <form class="form-horizontal" action="{{ route('carta.generarpdf') }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="nro_carta">Carta Nro: <span class="ntoCarta"></span></label>
                    <input type="hidden" class="form-control" id="nro_carta" placeholder="Ingrese nro_carta" name="nro_carta" value="">
                </div>

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nro_solicitud">Solicitud:</label>
